...
import static examples.com.intelligt.modbus.examples.ActivatedScreen.c1p1val;
import static examples.com.intelligt.modbus.examples.ActivatedScreen.c2p2val;
...
public class DynamicLineAndTimeSeriesChart extends ApplicationFrame implements ActionListener {
    ...
    private double lastValue = 300.0;
    ...
    public DynamicLineAndTimeSeriesChart(final String title) {
        ...
        super(title);
        this.series1 = new TimeSeries("Paramater1", Millisecond.class);
   ...
   //     final ChartPanel chartPanel2 = new ChartPanel(chart2);
    ...
    public  void actionPerformed(final ActionEvent e) {
        ...
        this.series1.add(new Millisecond(),this.lastValue);// ActivatedScreen.c1p1val[1]);
    ...
    //public static void drawGraph(){
        ...
        final DynamicLineAndTimeSeriesChart demo = new DynamicLineAndTimeSeriesChart("Realtime Graph");
        demo.pack();
